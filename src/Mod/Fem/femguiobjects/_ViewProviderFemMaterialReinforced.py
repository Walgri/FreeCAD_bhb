...
class _ViewProviderFemMaterialReinforced:
    ...
    def claimChildren(self):
        if self.Object.Matrix and self.Object.Reinforcement:
            return (self.Object.Matrix + self.Object.Reinforcement)
        elif not self.Object.Matrix and self.Object.Reinforcement:
            return self.Object.Reinforcement
        elif self.Object.Matrix and not self.Object.Reinforcement:
            return self.Object.Matrix
    ...
    def canDragObject(self, dragged_object):
        if hasattr(dragged_object, "Proxy") and dragged_object.Proxy.Type == "Fem::Material":
            return True
        else:
            return False
    ...
    def dropObject(self, selfvp, incoming_object):
        if hasattr(incoming_object, "Proxy") and incoming_object.Proxy.Type == "Fem::Material":
            objs = self.Object.MeshBoundaryLayerList
