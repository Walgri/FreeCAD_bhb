...
class _TaskPanelFemResultShow:
    ...
    def calculate(self):
        ...
        self.set_result_stats("", minm, avg, maxm)
        QtGui.QApplication.restoreOverrideCursor()
        del x, y, z, T, Von, Peeq, P1, P2, P3, sx, sy, sz, ex, ey, ez, MF, NP, rx, ry, rz, mc, s1x, s1y, s1z, s2x, s2y, s2z, s3x, s3y, s3z   # Dummy use of the variables to get around flake8 error
