...
class _FemMaterialReinforced:
    ...
    def __init__(self, obj):
        ...
        obj.addProperty("App::PropertyLinkSub", "Matrix", "Composites", "Matrix material")
        obj.addProperty("App::PropertyLinkSub", "Reinforcement", "Composites", "Reinforcement material")
        obj.Proxy = self
