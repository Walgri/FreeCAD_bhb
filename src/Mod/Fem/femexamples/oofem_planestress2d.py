...
def setup_planestress2d(doc=None, solver='oofem'):
    ...
    displacement_constraint2 = analysis.addObject(ObjectsFem.makeConstraintDisplacement(doc, name="ConstraintDisplacmentGleit"))[0]
...
def run_planestress2d(doc=None, solver='oofem'):
    # test oofem input file writing for CalculiX cantilever loaded by 9 MN as node loads

    doc = setup_planestress2d(doc, solver)
    from femexamples.manage import run_analysis
    run_analysis(doc, 'OOFEM_PlaneStress2D')
